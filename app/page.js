...
import { getRandomProducts , getBestSellers, getFeaturedProducts } from "@/lib/product-helpers"
...
export default async function HomePage() {
  ...
  return (
    <main>
      ...
      <Suspense fallback={<div className="h-96 flex items-center justify-center">Loading flash sales...</div>}>
        <FlashSales products={flashSaleProducts} />
      </Suspense>
      <BrowseByCategory />
      <Suspense fallback={<div className="h-96 flex items-center justify-center">Loading best selling...</div>}>
